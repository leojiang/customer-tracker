...
const translations = {
  'en': {
    ...
    'chat.noSessions': 'No chat sessions',
    ...
    'chat.messageFailed': 'Failed to send message',
    'chat.loadingMessages': 'Loading messages...',
    'chat.loadingSessions': 'Loading chat sessions...',
    'chat.error': 'Error loading chat',
    'chat.retry': 'Retry',
    'chat.searchUsers': 'Search Users',
    'chat.searchUsersHint': 'Enter phone number to find users',
  ...
  'zh-CN': {
    ...
    'chat.noSessions': '暂无聊天会话',
    'chat.startConversation': '开始对话',
    'chat.unreadMessages': '未读消息',
    'chat.markAsRead': '标记为已读',
    'chat.lastSeen': '最后在线',
    'chat.online': '在线',
    'chat.offline': '离线',
    'chat.typing': '正在输入...',
    'chat.messageSent': '消息已发送',
    'chat.messageFailed': '发送消息失败',
    'chat.loadingMessages': '加载消息中...',
    'chat.loadingSessions': '加载聊天会话中...',
    'chat.error': '加载聊天失败',
    'chat.retry': '重试',
    'chat.searchUsers': '搜索用户',
    'chat.searchUsersHint': '输入电话号码查找用户',
    'chat.noUsersFound': '未找到用户',
    'chat.startNewChat': '开始新聊天',
