...
class CustomerServiceTest {
    ...
    @Mock
    private StatusTransitionValidator transitionValidator;
    ...
    void shouldGetStatusHistorySuccessfully() {
        // Given
        List<StatusHistory> statusHistoryList = Arrays.asList(
    ...
    void shouldThrowExceptionWhenTryingToRestoreNonDeletedCustomer() {
        ...
        IllegalArgumentException exception = assertThrows(
            IllegalArgumentException.class,
            () -> customerService.restoreCustomer(testCustomerId)
        );
    ...
    void shouldGetValidTransitionsSuccessfully() {
        // Given
        Set<CustomerStatus> expectedTransitions = Set.of(CustomerStatus.REPLIED_TO_CUSTOMER, CustomerStatus.LOST);
    ...
    private StatusHistory createStatusHistory(Customer customer, CustomerStatus fromStatus, CustomerStatus toStatus, String reason) {
