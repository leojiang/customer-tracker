...
public interface CustomerRepository
  ...
  /** Find customer by ID card and certificate type. */
  Optional<Customer> findByIdCardAndCertificateType(
      String idCard, com.example.customers.model.CertificateType certificateType);

  /**
   * Find customer by name, phone, and certificate type (DEPRECATED - use
   * findByIdCardAndCertificateType).
   */
  @Deprecated
