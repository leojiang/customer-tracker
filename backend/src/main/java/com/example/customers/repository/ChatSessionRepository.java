 ...
 *
 * <p>Provides methods for finding chat sessions by participants and retrieving
 * paginated lists of sessions for a user.
 */
@Repository
public interface ChatSessionRepository extends JpaRepository<ChatSession, Long> {
   ...
   */
  @Query("SELECT COUNT(cs) > 0 FROM ChatSession cs WHERE " +
         "(cs.participant1Phone = :participant1 AND cs.participant2Phone = :participant2) OR " +
         "(cs.participant1Phone = :participant2 AND cs.participant2Phone = :participant1)")
